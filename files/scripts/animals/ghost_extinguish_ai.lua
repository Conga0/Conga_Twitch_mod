...
if isBurning then
	...
	for i=1,how_many do
		...
		shoot_projectile( entity_id, "mods/conga_twitch_mod/files/entities/projectiles/mass_status_wet_effect.xml", pos_x, pos_y, vel_x, vel_y )
	...
	for i,v in ipairs( targets ) do		
		if EntityHasTag(v, "hittable") then
			local eid = EntityLoad( "mods/conga_twitch_mod/files/entities/misc/effect_status_wet_ailment.xml", pos_x, pos_y )
