...
elseif rainbowCatSeed >= 47 then
	EntityLoad( "mods/conga_twitch_mod/files/entities/" .. catPath .. "/cat_mocreeps_wizard.xml", pos_x, pos_y )
	valid = false
end
...
elseif ((goldenCatSeed >= 40) and (valid == true)) then
	EntityLoad( "mods/conga_twitch_mod/files/entities/" .. catPath .. "/cat_mocreeps_skateboard.xml", pos_x, pos_y )
	valid = false
end
